  ...
  return (
    <Layout>
      <main className="flex-1 px-8 py-12 max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6 text-[#0A2B5D] text-center">
          Contact Us
        </h1>
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="space-y-6">
            <section>
              <h2 className="text-2xl font-semibold text-[#0A2B5D] mb-3">
                Get in Touch
              </h2>
              <p className="text-gray-700 text-justify mb-6">
                We&apos;re here to help! Whether you have questions about our
                services, need technical support, or want to explore business
            ...
            <section className="mt-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 border rounded-lg">
                  <h3 className="text-lg font-semibold text-[#0A2B5D] mb-2">
                    Customer Support
                  </h3>
                  <p className="text-gray-700">Email: hello@medicause.in</p>
                  <p className="text-gray-700">Phone: +91 9654470275</p>
                </div>
                <div className="p-4 border rounded-lg">
                  <h3 className="text-lg font-semibold text-[#0A2B5D] mb-2">
                    Business Inquiries
